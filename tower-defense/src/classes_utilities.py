...
class Message(pygame.sprite.Sprite):
	...
	'''
	def __init__(self, msg, center, font=textFont, color=white):
		self.text = msg
		self.font = font
	...
	def changeMessage(self, newMsg, font=textFont, color=white):
		self.text = newMsg
...
class Button:
	...
	"""
	def __init__(self, text, center, font=textFont, color=white):
		self.text = text
		self.font = font
	...
	def changeText(self, newText, color=white):
		self.text = newText
...
class GraphicButton:
	...
	def __init__(self,topleft, data_number, font=textFont2):
